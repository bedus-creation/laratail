...
<div class="container mx-auto my-10 px-6 md:px-12">
    <div class="flex justify-between items-center">
        <div class="flex-1">
            ...
            <p class="font-light">
                All the are users liststed here. Edit <b>UsersController</b> to customize further logics.
            </p>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="flex justify-end">
                        <a href="#"
                            x-on:click.prevent="showDeleteModal=!showDeleteModal; setModalData('{{route('users.destroy', $item->id)}}');"
