        ...
        <form action="{{route('articles.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <select name="categories" id="categories" class="w-full border select"
                    ...
                    <option class="py-4" value="AK">Alaska</option>
                    <option class="py-4" value="HI">Hawaii</option>
                    <option class="py-4" value="CA">California</option>
                    <option class="py-4" value="NV">Nevada</option>
                    <option class="py-4" value="OR">Oregon</option>
                    <option class="py-4" value="WA">Washington</option>
                </select>
            </div>
            <div class="mb-2">
