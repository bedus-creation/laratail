...
<div class="container mx-auto my-10 px-6 md:px-12">
    <div class="flex justify-between items-center">
        <div class="flex-1">
            <h3 class="text-gray-700 text-3xl font-semibold mb-2">Add Category</h3>
            <p class="font-light">
                This is the place to add new Categories.
            </p>
        </div>
    ...
    <div class="w-3/4 bg-white mt-16 px-6 py-12 rounded-lg shadow-lg">
        <form action="{{route('categories.store')}}" method="POST">
            @csrf
            <div class="mb-6">
                <label class="block text-gray-600 font-light mb-2">categories</label>
